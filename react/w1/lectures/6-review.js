...
class ExampleClass4 {
  ...
  addName(newName) {
    ...
    let duplicatesFound = this.names.filter((existingName) => {
      if (existingName.name === newName.name) {
        return existingName;
      }
    });
...
let objFromE4 = new ExampleClass4(names);

console.log(objFromE4);
